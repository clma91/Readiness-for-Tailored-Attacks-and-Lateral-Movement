...
\subsection{Main Goal and Final Conclusion}
Zu Beginn war noch nicht ganz klar wie das Tool genau aufgebaut werden soll und wonach sich die Funktionalität und der Scope richten soll. Nach gründlicher Analyse von verschiedenen Tools, Berichten und Studien konnte immer besser eingeschätzt werden wie eine effiziente Detektion der Readiness eines Systems implementiert werden kann. Es wäre wünschenswert gewesen auf einem bestehendem Tool aufbauen zu können, wie sich aber in einer fünf-wöchigen Analyse gezeigt hat, besteht kein entsprechendes Tool dafür. Aus diesem Grund wurde der Entschluss gefasst ein eigenes Tool auf Basis der Studie \nameref{JPCertStudy} zu entwickeln. Diese Studie gibt einen 
