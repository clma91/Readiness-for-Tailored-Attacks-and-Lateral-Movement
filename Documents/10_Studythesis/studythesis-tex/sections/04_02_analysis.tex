...
\subsection{Mandatory Event Logs}
...
\begin{table}[H]
    ...
    \begin{tabular}{| p{1.5cm} | p{14.5cm} |} \hline
        ...
        \textbf{EventID} & \textbf{Description}  \\ \hline
        1 & Process Create \\ \hline
        5 & Process Terminated \\ \hline
        8 & CreateRemoteThread detected \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{| p{8cm} | p{8cm} |} \hline
        ...
        \textbf{Subcategory} & \textbf{EventIDs}  \\ \hline
        Audit User Account Management & 4720(S), 4726(S) \\ \hline
        Audit Security Group Management & 4728 (S, F), 4729 (S, F) \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{| p{8cm} | p{8cm} |} \hline
        ...
        Audit Filtering Platform Connection & 5154(S), 5156(S) \\ \hline	
    \end{tabular}
