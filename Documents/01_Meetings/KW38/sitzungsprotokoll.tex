...
\begin{itemize}
    ...
    \item Fragen
    \item Besprechung erste Version Projektplan (Meilensteine)
...
\begin{itemize}
    \item Cobalt Strike
    \item Ist es möglich eine Testumgebung für uns zur Verfügung zu stellen? (Tool sehen theoretisch gut aus, aber praktisch auch gut?)
