...
\begin{tabular}{p{4cm} p{12cm}}
    ...
    \textbf{Woche:} & 8 \\
    \textbf{Datum / Zeit} & 06.11.2018 08:30 - 09:30 \\
\end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{p{12cm} p{4cm}}
        ...
        UC01: Read Resultant Set of Policies & Abgeschlossen \\ \hline
        UC02: Analyse Audit Policies & Abgeschlossen \\ \hline
        UC03: Find Event Logs & Abgeschlossen \\ \hline
        UC04: Analyse Found Event Logs & Abgeschlossen \\ \hline
        Schreiben der Dokumentation & in Bearbeitung \\ \hline
        CI und Pester-Tests & in Bearbeitung \\ \hline
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{p{12cm} p{4cm}}
        ...
        Abschluss und Retrospektive Sprint 1 & Team  \\ \hline
        Beginn und Taskaufteilung Sprint 2 & Team \\ \hline
        UC05 \& UC06 in Angriff nehmen & Team \\ \hline
...
\begin{itemize}
    \item LSA
    \item Wishlist: Möglichkeit zur Offline-Verwendung bieten
\end{itemize}
