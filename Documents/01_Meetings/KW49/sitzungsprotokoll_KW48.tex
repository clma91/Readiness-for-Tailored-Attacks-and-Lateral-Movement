...
\begin{tabular}{p{4cm} p{12cm}}
    ...
    \textbf{Woche:} & 12 \\
    \textbf{Datum / Zeit} & 04.12.2018 08:30 - 09:30 \\
\end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{p{12cm} p{4cm}}
        ...
        UC05: Display missing or wrong system configuration & Abgeschlossen \\ \hline
        UC07: Create Main Script & Abgeschlossen \\ \hline
        UC08: Get Domain Information & Abgeschlossen \\ \hline
    \end{tabular}
\end{table}
...
\subsection*{Fragen}
\begin{itemize}
    \item Lohnt sich das Meeting vom 11.12.2018?
\end{itemize}
...
\begin{table}[H]
    ...
    \begin{tabular}{p{12cm} p{4cm}}
        ...
        Refactoring & Team \\ \hline
        English Consulting Meeting am 06.12.2018 & Team \\ \hline
    \end{tabular}
\end{table}
...
\begin{itemize}
    \item Ausfall des Meetings von 11.12.2018
    \item Resultat-PDF überzähliges '','' entfernen
    \item Beim schreiben des Abstracts auf Vorgabe des Abgabetools achten (Ausgangslage, Vorgehen, Ergebnis)
    \item Management Summary $\rightarrow$ was kann es und wo ist das Potenzial? (Max. 1 Seite)
\end{itemize}
\end{document}