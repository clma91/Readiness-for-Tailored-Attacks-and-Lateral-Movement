...
\begin{table}[H]
    ...
    \begin{tabular}{p{12cm} p{4cm}}
        ...
        Abgabe gemäss Besprechung & Team \\ \hline
    \end{tabular}
\end{table}
...
\begin{itemize}
    \item Überraschungsbesuch ist geglückt
    \item Wir wünschen frohe Festtage und än guätä Rutsch
\end{itemize}
\end{document}